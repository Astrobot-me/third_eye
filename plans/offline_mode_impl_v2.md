...
|--------|--------|------------|
| Default mode | ✅ None | Remains `passive` |
| Passive/Active behavior | ✅ None | Logic unchanged |
| ESP32 MODE_ACTIVE/PASSIVE | ⚠️ Fixed | Use `setMode()` instead of `toggleMode()` |
| UI mode button | ✅ None | Cycles through 3 modes |
| Active mode trigger | ✅ None | Guarded with `mode !== 'active'` check |
